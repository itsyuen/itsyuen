# Semester Ontology and Todoist Operating Cycle
...
The professional ontology has two different time scales that should not be forced into the same tool.

The **research coordinates and professional boundaries are relatively reusable**. The contents placed inside them — Outcomes, Milestones, active questions, routes, evidence, and priorities — change as research, teaching, students, collaborators, industry, and external obligations change.

The operating principle is therefore:

```text
stable-enough coordinates / boundaries
        ↓
...
The semester map should preserve the **main preferred hierarchy in each relevant coordinate or professional world**.

It may include:

- research coordinates such as `#iVj_k`;
- the main Outcome currently associated with a coordinate;
- important Milestones or routes when they clarify the hierarchy;
- important relationships between #1–#3 Research, #4 Infrastructure, Teaching, Industry Projects, and Administration;
- major evidence/artifact destinations when these clarify where the work is going;
- intentionally empty coordinates when the emptiness itself is meaningful.

The map may be more complete than Todoist. Its job is orientation, not daily execution.

A simple conceptual form is:

```text
coordinate / professional world
        ↓
preferred main Outcome
        ↓
major Milestone(s) / route(s)
        ↓
expected evidence / artifact direction
```
...
> **What was this work really trying to accomplish, what evidence/artifacts now exist, and what new structure emerged during the semester?**

Use the semester's Todoist structure, completed and unfinished work, Markdown notes, code, figures, experiments, reports, and other artifacts as evidence.

Recover:

- the true intention of important work;
- the hierarchy that became visible through execution;
- the evidence and artifact set that now exists;
- new coordinates or branches that genuinely emerged;
...
> **Given what I now know, what is the clearest main hierarchy for the next semester?**

Now the recovered material may be:
...
- promoted;
- demoted;
- moved to a better coordinate;
- reframed as Infrastructure, Teaching, Industry, Administration, or Finance;
- retained for a later period;
- archived or discarded when its role has ended.
